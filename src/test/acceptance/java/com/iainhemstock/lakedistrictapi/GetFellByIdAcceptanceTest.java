...
//        .then()
//        .assertThat()
//            .body(matchesJsonSchemaInClasspath("schemas/fell_detailed_schema.json"));
//    }
//
//    @Test
//    @Parameters
...
//            .root("height")
//                .body("feet", is(fellDTO.getHeight().get("feet")))
//                .body("meters", is(fellDTO.getHeight().get("meters")))
//            .root("location")
...
//                .body("latitude", is(fellDTO.getLocation().getLatitude()))
//                .body("longitude", is(fellDTO.getLocation().getLongitude()))
...
//            .root("prominence")
//                .body("feet", is(fellDTO.getProminence().get("feet")))
//                .body("meters", is(fellDTO.getProminence().get("meters")));
//    }
//
