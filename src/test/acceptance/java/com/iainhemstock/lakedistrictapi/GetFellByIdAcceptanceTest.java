    ...
    public void when_sending_get_request_for_fell_by_id_then_all_data_of_that_fell_will_be_returned(int validId, FellDTO fellDTO) {
        ...
        .then().assertThat()
            ...
            .root("location.coords.dms.y")
                .body("formatted", is(fellDTO.getLocation().getCoords().getDmsCoords().getyDms().getFormatted()))
                .body("degrees", is(fellDTO.getLocation().getCoords().getDmsCoords().getyDms().getDegrees()))
                .body("minutes", is(fellDTO.getLocation().getCoords().getDmsCoords().getyDms().getMinutes()))
                .body("seconds", is(fellDTO.getLocation().getCoords().getDmsCoords().getyDms().getSeconds()))
                .body("hemisphere", is(fellDTO.getLocation().getCoords().getDmsCoords().getyDms().getHemisphere()))
            .root("location.coords.dms.x")
                .body("formatted", is(fellDTO.getLocation().getCoords().getDmsCoords().getxDms().getFormatted()))
                .body("degrees", is(fellDTO.getLocation().getCoords().getDmsCoords().getxDms().getDegrees()))
                .body("minutes", is(fellDTO.getLocation().getCoords().getDmsCoords().getxDms().getMinutes()))
                .body("seconds", is(fellDTO.getLocation().getCoords().getDmsCoords().getxDms().getSeconds()))
                .body("hemisphere", is(fellDTO.getLocation().getCoords().getDmsCoords().getxDms().getHemisphere()))
            .root("prominence")
