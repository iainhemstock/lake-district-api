    ...
    public void addGreatGable() {
        Fell greatGable = new Fell(
            ...
            new OsMaps(new HashSet<>(Set.of(
                new OsMap(1, "OS Landranger 89", new OsMapName("OS Landranger 89")),
                new OsMap(2, "OS Landranger 90", new OsMapName("OS Landranger 90")),
                new OsMap(7, "OS Explorer OL6", new OsMapName("OS Explorer OL6"))))),
