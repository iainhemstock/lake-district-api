...
//import com.iainhemstock.lakedistrictapi.services.mappers.FellDtoMapper;
...
//                content().contentType(MediaType.APPLICATION_JSON))
//            .andExpect(
//                jsonPath("$.height.feet", is(equalTo(scafellPikeFellDTO.getHeight().get("feet")))))
//            .andExpect(
//                jsonPath("$.height.meters", is((equalTo(scafellPikeFellDTO.getHeight().get("meters"))))));
//    }
//
//    @Test
...
//                content().contentType(MediaType.APPLICATION_JSON))
//            .andExpect(
//                jsonPath("$.prominence.feet", is(equalTo(scafellPikeFellDTO.getProminence().get("feet")))))
//            .andExpect(
//                jsonPath("$.prominence.meters", is((equalTo(scafellPikeFellDTO.getProminence().get("meters"))))));
//    }
//
//    @Test
...
//                    is(equalTo(scafellPikeFellDTO.getLocation().getLatitude()))))
//            .andExpect(
//                jsonPath("$.location.coords.decimal.longitude",
//                    is((equalTo(scafellPikeFellDTO.getLocation().getLongitude())))));
//    }
//
//    @Test
