...
INSERT INTO os_maps (name) VALUES ('OS Landranger 96')^;
SET @os_map_lr_96_id = (SELECT last_insert_id())^;

INSERT INTO os_maps (name) VALUES ('OS Landranger 97')^;
...
CREATE FUNCTION fell_insert(
    in_name VARCHAR(50),
    in_height_meters INT,
    in_region_id INT,
    in_prominence_meters INT,
    in_parent_peak_id INT
)
RETURNS INT
DETERMINISTIC
BEGIN
...
INSERT INTO fells_classifications (fell_id, classification_id) VALUES (@scafell_pike_id, @country_high_point_id)^;
